...
class Prowl
{
	...
	private $api_key = '5eaee24134c0a35c992dcdb173eb6b93d61a63d9';
	private $api_provider_key = 'fb543563ebe2112cb959d5798f314c63d42780af';
	...
	{
    $ci = get_instance();
    $ci->load->config('prowl',TRUE);
		$config = $ci->config->item('prowl');
	...
	public function add($description=NULL,$event=NULL,$url=NULL,$application = "php-prowl",$priority = 0) {
